...
describe('UserEntity integration Tests', () => {
  ...
  describe('UpdatePassord Method', () => {
    it('Should a invalid user using invalid password field', () => {
      ...
      expect(() => entity.updatePassword(15 as any)).toThrow(EntityValidationError);
